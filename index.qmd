...
[Get started](https://nbdev.fast.ai){.btn-action-primary .btn-action .btn .btn-success .btn-lg role="button"}

![](card.png){style="margin-top: 40px; margin-bottom: 40px"}
...
![](netflix.svg){height=26px stlye="position: relative; top: 1px"}
:::
::: {.g-col-12 .g-col-sm-6 .g-col-md-3}
![](transform.svg){height=26px style="position: relative; bottom: 1px"}
:::
::: {.g-col-12 .g-col-sm-6 .g-col-md-3}
![](outerbounds.svg){height=23px style="position: relative; bottom: 1px"}
:::
::: {.g-col-12 .g-col-sm-6 .g-col-md-3}
![](novetta.svg){height=30px style="position: relative: top: 1px"}
:::
::: {.g-col-12 .g-col-sm-6 .g-col-md-3}
![](amd.svg){height=22px}
:::
::: {.g-col-12 .g-col-sm-6 .g-col-md-3}
![](overstory.png){height=26px}
:::
::: {.g-col-12 .g-col-sm-6 .g-col-md-3}
![](bom.png){height=46px style="position: relative; bottom: 12px"}
:::
::: {.g-col-12 .g-col-sm-6 .g-col-md-3}
![](lyft.svg){height=34px}
:::
:::
...
[Install nbdev](https://nbdev.fast.ai){.btn-action-primary .btn-action .btn .btn-success .btn-lg role="button"}
:::
